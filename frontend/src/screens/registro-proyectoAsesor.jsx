        ...
        <Col md={9} className="p-4">
          <Row className="mb-4 align-items-center">
            ...
            <Col md={4} className="d-flex justify-content-end">
              ...
              >
                ...
                <option value="registrarUsuario">Registrar Usuario</option>
                <option value="testearTurnitin">Testear Proyecto Turnitin</option>
          ...
          <div className="row">
            {grupoSeleccionado === "registrarProyecto" ? (
              ...
              <p>
                Opción <strong>{grupoSeleccionado}</strong> aún no tiene
                archivos.
              </p>
            ) : (
